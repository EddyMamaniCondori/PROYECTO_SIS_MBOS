          ...
          <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="card mt-4">
                            ...
                            <div class="card-body">
                                <table id="example" class="display">
                                    ...
                                    <tbody>
                                        @foreach ($desafios_ins_est as $desafio1)
                                        <tr @class(['text-danger' => $desafio1->tipo == 'Filial'])>
  
                                            <td>
                                                {{$desafio1->codigo}}
                                            </td>
                                            <td>
                                                {{$desafio1->nombre_iglesia}}
                                            </td>
                                            <td>
                                                {{$desafio1->desafio_estudiantes}} 
                                            </td>
                                            <td>
                                                {{$desafio1->estudiantes_alcanzados}}
                                            </td>
                                            <td>
                                                {{$desafio1->desafio_instructores}} 
                                            </td>
                                            <td>
                                                {{$desafio1->instructores_alcanzados}}
                                            </td>
                                            <td> 
              ...
              <div class="col-lg-5 ">
                ...
                <div class="card mt-4">
                  <div class="card-body">
                    <h5 id="tituloGrafica-dinamico" class="card-title text-center"></h5>
                    <div id="revenue-chart-dinamico" style="min-height: 320px;"></div>
                  </div>
                </div>
              </div>
              <!--termina grafica-->
  ...
  <script>
    ...
    document.querySelectorAll('.ver-grafica').forEach(btn => {
      btn.addEventListener('click', function() {
        ...
        // Actualizar título
        document.getElementById('tituloGrafica-dinamico').innerText = 'Iglesia ID: ' + idIglesia;

        // Crear gráfico
        const chartOptions_est = {
          series: [
        ...
        window.graficoApex = new ApexCharts(
          document.querySelector("#revenue-chart-dinamico"),
          chartOptions_est
        );
