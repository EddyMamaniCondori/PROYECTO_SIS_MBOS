            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Unidades Educativas Elimandas</li>
                </ol>
              </div>
              <div class="row pb-3">
                <a href="{{route('asea.index')}}"><button type="button" class="btn btn-success"> <i class="bi bi-chevron-bar-left"></i> Volver</button> </a><br>
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$ue->id_ue}}"> <i class="bi bi-exclamation-circle-fill"></i>Reactivar</button>
                                                </div>
                                            </td>
                                        </tr>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <strong> Nombre: </strong> {{$ue->nombre_ue}}
                                                            
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                                            <form action="{{ route('asea.reactive',['id'=>$ue->id_ue])}}" method="POST">
                                                                @csrf
