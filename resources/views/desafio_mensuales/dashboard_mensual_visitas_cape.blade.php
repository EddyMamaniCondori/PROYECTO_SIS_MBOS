...
<div class="container-fluid mt-4">
    <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6"><h3 class="mb-0"><strong> Avance de Capellanes en Visitas {{$meses_array[$mes]}} del {{$anio}}</strong></h3>
                </div>
                <div class="col-sm-6">
...
document.querySelectorAll('.ver-grafica').forEach(btn => {
    btn.addEventListener('click', function() {
        ...
        const idUE = this.dataset.id;
        const data = datosGraficos.find(d => d.id_ue == idUE);
