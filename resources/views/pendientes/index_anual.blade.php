...
@endif
        ...
        <div class="app-content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6"><center><h3 class="mb-0">Pendientes de la gestion 2025 </h3></center></div>
              <div class="col-sm-6">
                            ...
                            <div class="card-body">
                                <table id="example" class="display">
                                    ...
                                    <tbody>
                                        ...
                                        <tr @if($dato->tipo === 'Filial') style="color: red;" @endif>
                                            <td>
                                                {{$dato->nombre_distrito}} 
                                            <td>
                                                {{$dato->nombre_p}} &nbsp; {{$dato->ape_paterno}} &nbsp;{{$dato->ape_materno}}
                                            </td>
                                            <td>
                                                {{$dato->codigo}}
                                            </td>
