...
@section('content')
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Editar Informacion del Personal</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <div class="app-content">
          <div class="container-fluid">
            <!--begin::TABLA-->
            <form action="{{ route('personales.update', $pastor->id_persona)}}" method="POST" > <!--en actiion va que accion vamos ha acer con este formulario una ves de click en guardar-->
                    @csrf
                    @method('PUT')
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="fecha_ingreso" id="fecha_ingreso" class="form-control" value="{{@old('fecha_ingreso',$pastor->fecha_ingreso)}}"> <!--name= debe tener mismo valor de la base de datos-->
                            @error('fecha_ingreso')
                                <small class="text-danger">{{$message}}</small>
                            @enderror
                        </div>
                        <div>
                            <a href="{{route('personales.index')}}"><button type="button" class="btn btn-danger"> Cancelar </button></a>
