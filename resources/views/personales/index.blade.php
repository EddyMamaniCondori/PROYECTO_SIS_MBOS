...
@endif
        ...
        <div class="app-content-header">
          <div class="container-fluid">
            <div class="row">
              <div class="col-sm-6"><h3 class="mb-0">Personal MBOS</h3></div>
              <div class="col-sm-6">
              ...
              <div class="row">
                <a href="{{route('personales.create')}}"><button type="button" class="btn btn-primary"> <i class="bi bi-person-plus-fill"></i> &nbsp Añadir nuevo registro </button> </a><br>
              </div>
              <div class="row pt-3">
                <a href="{{route('personales.indexdelete')}}"><button type="button" class="btn btn-danger"> <i class="bi bi-person-fill-x"></i> &nbsp Personales Desactivados </button> </a><br>
              </div>
            </div>
          </div>
        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td> 
                                                <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                                                    ...
                                                    <a href="{{ route('personales.edit', $persona->id_persona) }}" class="btn btn-warning">
                                        ...
                                        <div class="modal fade" id="confirmModal-{{$persona->id_persona}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-body">
                                                    <strong style="color: red;">¿Seguro que quieres eliminar a este personal? </strong><br>
                                                    <strong> Nombre: </strong> {{$persona->nombre}} &nbsp {{$persona->ape_paterno}} &nbsp  {{$persona->ape_materno }}
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                                    <form action="{{ route('personales.destroy',['personale'=>$persona->id_persona])}}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
